...
# Objetivo: Comparar los torques calculados por los algoritmos del metodo A, metodo B y en ADAMS.
...
def nodo():
    ...
    while not rospy.is_shutdown():
        ...
        if (permiso_2 == True and id_call_2 != id_permiso_2 and (
            ...
            mi_path1 =path_root+ "resultado_trayectorias/Tray_"+str(num_tray_2)+"_XYZ.txt"
            mi_path2 =path_root+ "resultado_trayectorias/Tray_"+str(num_tray_2)+"_Theta.txt"
            mi_path3 =path_root+ "resultado_trayectorias/Tray_"+str(num_tray_2)+"_Tiempo.txt"
            ...
            mi_path11 =path_root+ "resultados_torque_metodo_a/Tray_"+str(num_tray_2)+"_Torque1.txt"
            mi_path22 =path_root+ "resultados_torque_metodo_a/Tray_"+str(num_tray_2)+"_Torque2.txt"
            mi_path33 =path_root+ "resultados_torque_metodo_a/Tray_"+str(num_tray_2)+"_Torque3.txt"
            ...
            #######  {{{ Cinematica Inversa }}} #######
            res_6 = delta_kinematics_Paderborn_tm1_adams.inverse_Paderborn_m(res_1[1], res_1[4], res_1[7])
            ####### {{{ Visualizacion Trayectoria Rviz}}} #######
            enviar = matriz_path_ls()
            enviar.x = res_1[1]
            enviar.y = res_1[4]
            ...
            pub1.publish(enviar)
            ####### {{{ Velocidad y Aceleracion Angular }}} #######
            res_10 = jacobian_Paderborn_tm1_v2_adams.jacobian_total_macel(res_1[1], res_1[4], res_1[7],
                                                                          res_1[2], res_1[5], res_1[8],
            ...
            ####### {{{ Leer Torque ADAMS }}} #######
            mi_path44 = path_root+"resultados_torque_adams/adams_"+str(num_tray_2)+".txt"
